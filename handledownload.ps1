...
function Copy-WithProgress {
    ...
    [void](handledownload\Copy-WithProgress -SourcePath $SourcePath -DestinationPath $DestinationPath)
}
...
function Copy-WithPathCheck {
    ...
    [void](handledownload\Copy-WithPathCheck -SourcePath $SourcePath -DestinationPath $DestinationPath)
}
...
function Extract-RarWith7Zip {
    ...
    return (handledownload\Extract-RarWith7Zip -RarFile $RarFile -OutputDir $OutputDir)
}
...
function Invoke-MovieTvFileProcessing {
    ...
    return (handledownload\Invoke-MovieTvFileProcessing -TorrentName $TorrentName -Category $Category -ContentPath $ContentPath)
}
